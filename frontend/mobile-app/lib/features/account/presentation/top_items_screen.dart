                ...
                children: <Widget>[
                        ...
                        Expanded(
                          child: Column(
                            children: <Widget>[
                              ...
                              Text('월간 기준', style: TextStyle(color: AppColors.text_secondary, fontSize: 12, fontWeight: FontWeight.w800)),
                            ],
                          ),
                        ),
                        IconButton(
                  ...
                  top_async.when(
                    ...
                    data: (items) {
                      if (items.isEmpty) {
                        return SectionCard(
                          child: Text('표시할 데이터가 없어요.', style: TextStyle(color: AppColors.text_secondary)),
                        );
                      }
